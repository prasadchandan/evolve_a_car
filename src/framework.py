    ...
    * Do NOT want to implement your own renderer:
    ...
    def Step(self, settings):
        ...
        if renderer:
            ...
            #                       )
            renderer.flags = dict(drawShapes=settings.drawShapes,
                                  drawJoints=State.draw_joints,
                                  drawAABBs=State.draw_aabb,
                                  drawPairs=State.draw_pairs,
                                  drawCOMs=State.draw_coms,
                                  convertVertices=is_extended)
        ...
        if renderer:
            ...
            State.fps = self.fps
            State.num_bodies = self.world.bodyCount
            State.num_joints = self.world.jointCount
            State.num_contacts = self.world.contactCount
            State.num_proxies = self.world.proxyCount
